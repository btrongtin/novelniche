    ...
    return (
        <div className="container" style={{height: 'calc(100vh - 210px)'}}>
            <div className="text-center">
                ...
                <p style={{fontSize:'16px'}}>Your order has been placed and is being processed. Your order id is {orderId}. You will receive an email with the order details.</p>
                <Link to='/' className='mt-4 btn btn-outline-success'>Back to homepage</Link>
            </div>
        </div>
    );
};
