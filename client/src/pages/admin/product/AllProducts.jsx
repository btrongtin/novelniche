...
const AllProducts = () => {
    ...
    console.log(
        'PDDD: ',
        products.map((pro) => {
            return { name: pro.title, author: pro.author };
        })
    );
    ...
    return (
        <div className="">
            ...
            <div className="row mt-5">
                <Link to='/admin/product' className='btn btn-primary mb-3 mr-3' style={{marginLeft:'auto'}}>Create new</Link>
            </div>
