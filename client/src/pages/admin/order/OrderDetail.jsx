                ...
                <>
                            ...
                            <div className="col-lg-4 col-md-4">
                                <form>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <p dangerouslySetInnerHTML={{__html: order.orderedBy?.address || '96 Le Hong Phong'}}></p>
                                    </div>
                                </form>
                            </div>
                            <div className="col-lg-4 col-md-4">
                    ...
                    <div className="ml-auto" style={{ width: '18rem' }}>
                        <div className="d-flex align-item-center justify-content-between">
                            ...
                            <span>{order.products?.reduce((accumulator, product) => accumulator + (product.product.price * product.count), 0)} VND</span>
                        </div>
                        <div className="d-flex align-item-center justify-content-between">
