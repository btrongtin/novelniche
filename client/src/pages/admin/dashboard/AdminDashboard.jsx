...
import { getDashboard, changeStatus } from '../../../functions/admin';
    ...
    return (
        <>
            ...
            {loading ? (
                ...
                <>
                    {console.log('DATA NEEEE: ', dashboardData)}

                    <TopCardHolder data={dashboardData.topCardData} />

                    <div className="row mb-4">
                        <div className="col-md-6 col-lg-6">
                            <StoreIncomeLineChart
                                data={dashboardData.storeIncomeData}
                            />
                        </div>
                        <div className="col-md-6 col-lg-6">
                            <div className="card shadow h-100">
                                ...
                                <div className="card-body row">
                                    {dashboardData.topSellingProductData &&
                                        dashboardData.topSellingProductData.map(
                                            (product) => (
                                                <div
                                                    key={product._id}
                            ...
                            <div className="card shadow h-100">
                                ...
                                <div className="card-body">
                                    {dashboardData.topOrderUserData &&
                                        dashboardData.topOrderUserData.map(
                                            (user) => (
                                                <div
                                                    key={user._id}
